    ...
    try:
        ...
        for model in vision_models:
            ...
            if response.status_code == 200:
                ...
                responses[model] = f"Error from {model}: {response.status_code}"
...
if __name__ == "__main__":
    image_path = "test1.png"  # Change to your test image
    query = "What skin condition is visible in this image?"
